...
if pythainlp.util.isthai(name, ignore_chars=" ") == True :
    ...
    if birthday == "อาทิตย์" and sumnum == 6:
        ...
        print('ไม่มงคล!', end =' ')
        if ls != []: print('อักษรกาลกิณี', ' '.join(ls))
    elif birthday == "อังคาร" and sumnum == 2:
        print('ไม่มงคล!', end =' ')
        if ls != []: print('อักษรกาลกิณี', ' '.join(ls))
    elif birthday == "พุธ" and sumnum == 3 or sumnum == 5:
        print('ไม่มงคล!', end =' ')
        if ls != []: print('อักษรกาลกิณี', ' '.join(ls))
    elif birthday == "พฤหัสบดี" and sumnum == 7:
        print('ไม่มงคล!', end =' ')
        if ls != []: print('อักษรกาลกิณี', ' '.join(ls))
    elif birthday == "ศุกร์" and sumnum == 8:
        print('ไม่มงคล!', end =' ')
        if ls != []: print('อักษรกาลกิณี', ' '.join(ls))
    elif birthday == "เสาร์" and sumnum == 4:
        print('ไม่มงคล!', end =' ')
        if ls != []: print('อักษรกาลกิณี', ' '.join(ls))
